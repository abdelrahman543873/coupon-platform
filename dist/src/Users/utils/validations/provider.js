...
const ProviderValidations = {
  add: Joi.object({
    ...
    cities: Joi.array().items({
      id: Joi.custom(checkMongooseId, "custom validation").required().error(errorsOverride),
      locations: Joi.array().items(locationSchema).required().error(errorsOverride)
    }).required().error(errorsOverride),
    ...
    facebookLink: Joi.string().allow("").min(3).optional().error(errorsOverride),
    instaLink: Joi.string().min(3).allow("").optional().error(errorsOverride),
    twittwerLink: Joi.string().min(3).allow("").optional().error(errorsOverride)
  }),
  login: Joi.object({
  ...
  updateProvider: Joi.object({
    ...
    facebookLink: Joi.string().min(3).optional().allow("").error(errorsOverride),
    instaLink: Joi.string().min(3).optional().allow("").error(errorsOverride),
    twittwerLink: Joi.string().min(3).optional().allow("").error(errorsOverride)
  }),
