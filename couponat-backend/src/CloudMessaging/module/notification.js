...
//       //to = await BazarModel.findById(message.to.id);
...
//       from = await BazarModel.findById(message.from.id);
//     console.log("from--", message.from);

//     console.log("tokeeen: ", tokenArray);
//     let messageNotification = {
//       notification: {
//         title:
//           (message.lang == "en" ? "Message from " : "رسالة من ") +
//           (message.from.type == "PROVIDER" ? from.name : from.username),
